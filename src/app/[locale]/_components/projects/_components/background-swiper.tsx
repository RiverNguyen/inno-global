...
export default function BackgroundSwiper({ data, thumbsSwiper, setActiveIndex }: IBackgroundSwiperProps) {
  return (
    <div className='absolute top-0 left-0 w-full h-full pointer-events-none xsm:h-[20.625rem]'>
      ...
      <div className='absolute bottom-0 left-0 w-full h-[33.17708rem] bg-[linear-gradient(0deg,rgba(0,0,0,0.90)_0%,rgba(0,0,0,0.00)_100%)] z-10 xsm:h-full xsm:bg-[linear-gradient(0deg,#000_22.37%,rgba(102,102,102,0.00)_42.53%)] opacity-[0.48]' />
    </div>
  )
}
