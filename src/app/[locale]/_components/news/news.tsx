...
import NewsItem, { INewsItem } from '@/app/[locale]/_components/news/_components/news-item'
...
export default function News({ data }: NewsProps) {
  return (
    <div className='w-full sm:h-[56.25rem] p-[6.22rem_0_4.24rem] xsm:p-[2.5rem_0.83rem]'>
      <div className='max-w-[85.42rem] mx-auto flex h-full xsm:flex-col xsm:max-w-full'>
        ...
        <div className='flex flex-col flex-1 sm:ml-[2.5rem] xsm:mt-[1.25rem]'>
          ...
          >
            ...
            />
            <span className='relative z-10 mr-[0.20833rem]'>Xem tất cả</span>
