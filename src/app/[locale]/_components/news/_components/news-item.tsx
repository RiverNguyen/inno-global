  ...
  return (
    <div className='flex items-center space-x-[1.04083rem] group xsm:space-x-[0.52083rem]'>
      ...
      >
        ...
        <span className='group-hover:text-[#D32F2F] self-end flex items-center space-x-[0.20833rem] text-[0.833rem] mt-auto text-[rgba(9,9,9,0.60)] opacity-80 transition-all duration-300 ease-in-out xsm:hidden'>
          Xem chi tiết{' '}
          <ChevronRight className='size-[0.833rem] group-hover:translate-x-[0.25rem] transition-all duration-300 ease-in-out' />
        </span>
      </Link>
    </div>
  )
