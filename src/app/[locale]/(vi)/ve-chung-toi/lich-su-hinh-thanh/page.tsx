    ...
    <main className='relative w-full'>
      ...
      <SectionPagination
        ...
        prev={{
          ...
          href: `${locale === 'vi' ? '/ve-chung-toi/van-hoa-doanh-nghiep' : '/about-us/corporate-culture'}`,
        }}
        center={{
          label: t('Breadcrumb.aboutUsPage'),
          href: `${locale === 'vi' ? '/ve-chung-toi' : '/about-us'}`,
        }}
        next={{
          label: t('Breadcrumb.socialResponsibilityPage'),
          href: `${locale === 'vi' ? '/ve-chung-toi/trach-nhiem-xa-hoi' : '/about-us/social-responsibility'}`,
        }}
      />
    </main>
  )
