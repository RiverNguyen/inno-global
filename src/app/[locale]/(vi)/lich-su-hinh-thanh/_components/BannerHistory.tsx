...
export default function BannerHistory({ banner }: { banner: IBannerHistory }) {
  ...
  return (
    <section className='xsm:h-[18.17708rem] relative h-screen w-full'>
      <Image
      ...
      <div className='absolute bottom-0 left-0 z-2 w-full p-[1.46rem_0.83rem] sm:px-[12.5rem] sm:py-[3.33333rem]'>
