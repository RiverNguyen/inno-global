  ...
  return (
    <>
      <div
        ...
        className={cn(
          'xsm:hidden pointer-events-none fixed top-0 left-0 z-[101] size-full bg-black/60 opacity-0 transition-opacity duration-200',
          openSearch && 'pointer-events-auto opacity-100',
        )}
      ></div>
      <header className='xsm:h-[2.92rem] xsm:shadow-[0_4px_30px_0_rgba(0,_0,_0,_0.06)] flex-y-center xsm:bg-white/80 fixed top-0 left-0 z-[102] h-[3.65rem] w-full bg-[#DADADA] shadow-[0_0_30px_0_rgba(0,_0,_0,_0.06)] backdrop-blur-[4px]'>
        <div
          className={cn(
      ...
      <div
        className={cn(
          'fixed top-0 left-0 z-[101] h-screen w-full overflow-y-auto bg-white px-[0.83333rem] pt-[calc(2.92rem+0.31rem)] transition-[transform,opacity] duration-200 ease-out will-change-transform sm:hidden pb-[20vh]',
      ...
      <div
        className={cn(
          'fixed top-0 left-0 z-[101] h-screen w-full overflow-y-auto bg-white px-[0.83333rem] pt-[calc(2.92rem+0.31rem)] transition-[transform,opacity] duration-200 ease-out will-change-transform sm:hidden',
          openSearch
