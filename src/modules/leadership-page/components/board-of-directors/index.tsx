...
const BoardSection = ({ title, directors }: { title: string; directors: DirectorCard[] }) => (
  <div className='xsm:gap-[1.25rem] flex flex-col gap-[3.33333rem]'>
    <h2 className='font-open-sans xsm:[text-box-edge:auto] xsm:[text-box-trim:none] xsm:text-[1.04167rem] xsm:leading-[150%] [text-box-edge:cap_alphabetic] [text-box-trim:trim-both] text-center text-[1.875rem] font-semibold leading-normal text-[rgba(9,9,9,0.80)]'>
      {title}
    </h2>
