    ...
    <div className="bg-white">
      <div className="w-full max-w-[75rem] mx-auto flex flex-col gap-[1.25rem] pt-[3.125rem] pb-[2.08333rem] xsm:p-[1.66667rem_0.83333rem_0.83333rem_0.83333rem] xsm:shadow-[0_4px_30px_0_rgba(0,0,0,0.08)]">
        ...
        <Breadcrumb className="xsm:hidden">
          <BreadcrumbList>
            <BreadcrumbItem>
              <BreadcrumbLink href="/">{t('LeadershipPage.home')}</BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/about">{t('LeadershipPage.about')}</BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>{t('LeadershipPage.title')}</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
