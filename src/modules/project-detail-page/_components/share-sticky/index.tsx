...
function IconFacebook(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50" fill="none" {...props}>
      <rect x="0.833333" y="0.833333" width="48.3333" height="48.3333" rx="24.1667" stroke="#D32F2F" strokeWidth="1.66667" />
      <path d="M22.4262 36.25V25.625H18.75V22.0833H22.4262V20.1815C22.4262 16.5805 24.2468 15 27.3532 15C28.8411 15 29.6278 15.1062 30 15.1549V18.5417H27.8816C26.5628 18.5417 26.1023 19.2119 26.1023 20.5702V22.0833H29.9669L29.4421 25.625H26.1023V36.25H22.4262Z" fill="#D32F2F" />
    </svg>
  )
}
...
function ShareSticky() {
  ...
  return (
    <aside className="sticky top-[30.25rem] flex flex-col">
      <span className="text-[#090909]/80 text-[0.83rem] font-semibold leading-[1.3] tracking-[-0.0083rem] whitespace-nowrap">Chia sẻ</span>
