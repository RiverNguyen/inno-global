      ...
      <div className='max-w-[75rem] h-full mx-auto'>
        <div className='xsm:py-[2.5rem] flex w-full xsm:flex-col h-full justify-center items-center'>
          <div className='xsm:w-auto xsm:mr-0 xsm:px-[0.83rem] w-[40.15625rem] mr-[5.31rem]'>
            <h2 className='xsm:mb-[1.25rem] xsm:mb-header-h1-26-semi pc-h2-54-s mb-[1.66667rem]'>
              {acfOurOffice.tittle}
            </h2>
            ...
            <Link
              ...
              className='flex-center group relative w-fit overflow-hidden rounded-[5.20833rem] px-[1rem] text-[0.73rem] leading-[1.5] text-[#090909]/60 outline outline-[#090909]/60 transition-all duration-300 hover:text-white hover:outline-none h-[2.083rem] xsm:mb-[2.08rem]'
            >
