  ...
  return (
    <div className='relative'>
      ...
      <div className='z-2 absolute bottom-0 left-0 w-full px-[12.5rem] py-[2.5rem] xsm:px-[0.83333rem] xsm:py-[1.25rem]'>
        ...
        <h1 className='font-open-sans xsm:text-[1.35417rem] xsm:leading-[120%] text-[2.08333rem] leading-[120%] font-semibold text-white w-[29.11458rem] xsm:w-full tracking-[-0.02813rem]'>
          {banner?.title}
        </h1>
      </div>
    </div>
