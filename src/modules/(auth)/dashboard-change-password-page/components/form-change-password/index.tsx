  ...
  return (
    <Form {...form}>
      <form
        ...
        className='w-full space-y-[1.51rem]'
      >
        ...
        <ButtonRed
          type='submit'
          className={`xsm:mt-[0.63rem] xsm:h-[2.083rem] h-[2.6rem] min-w-[8rem] text-[0.73rem] leading-[1.5] ${form.formState.isSubmitting ? 'cursor-not-allowed opacity-50' : ''}`}
          disabled={form.formState.isSubmitting}
        >
