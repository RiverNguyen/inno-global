...
export default function TrainingListPage({
  ...
  return (
    <>
      ...
      <div className='xsm:pt-[2.08rem] pt-[6.25rem]'>
        <div className='xsm:max-w-full mx-auto max-w-[75rem]'>
                  ...
                  >
                    ...
                    <div className='absolute z-2 flex size-full flex-col justify-between p-[0.9375rem]'>
                      <div className='w-[17.08333rem] space-y-[0.41667rem]'>
                        <div className='font-open-sans w-fit space-x-[0.20833rem] rounded-[5.20833rem] bg-[radial-gradient(298.39%_130.99%_at_6.62%_16.15%,#CA2A2A_15.19%,#D32F2F_53.77%,#FF6E6E_100%)] p-[0.20833rem_0.83333rem] text-[0.625rem] leading-[150%] font-semibold whitespace-nowrap text-white capitalize'>
                          <span>{t('format')}:</span>
                          <span>{training?.taxonomies?.training_format[0]?.name}</span>
                        </div>
          ...
          <div
            ...
            id='training-list'
          >
            <h2 className='font-open-sans xsm:text-[1.25rem] xsm:mb-[1.25rem] mb-[0.52083rem] text-[2.8125rem] leading-[120%] font-semibold tracking-[-0.02813rem] text-[#090909]'>
              {t('other')}
            </h2>
            <div className='xsm:pt-0 xsm:pb-[0.83333rem] xsm:flex-col flex items-center justify-between py-[1.25rem]'>
