...
export default function Banner({ banner }: { banner: ITrainingAcfData['banner'] }) {
  ...
  return (
    <div className='relative'>
      ...
      <div className='xsm:px-[0.83333rem] xsm:py-[1.25rem] absolute bottom-0 left-0 z-2 max-w-[75rem] mx-auto right-0 py-[3.33333rem]'>
        ...
        <h1 className='font-open-sans xsm:text-[1.35417rem] text-[2.08333rem] leading-[120%] font-semibold text-white sm:tracking-[-0.03125rem]'>
          {banner?.title}
        </h1>
      </div>
    </div>
