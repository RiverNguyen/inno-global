    ...
    <div className="bg-white py-[2.96875rem] xsm:py-[3.33333rem] xsm:px-[0.83333rem]">
      <div className="flex max-w-[75.1rem] mx-auto justify-between items-center">
        ...
        {center.href !== undefined ? (
          ...
          <div className="flex-center py-[0.41667rem] border-b border-[#D32F2F] text-[#D32F2F] font-open-sans text-[0.83333rem] font-semibold leading-[130%] tracking-[-0.00833rem] xsm:text-[0.625rem] xsm:leading-[150%] xsm:tracking-normal">
            {center.label}
          </div>
        )}
